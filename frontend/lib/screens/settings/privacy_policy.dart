...
class _PrivacyPolicyState extends State<PrivacyPolicy> {
  ...
  Future<void> getUserToken() async {
    ...
    _token = token ?? "";
    _language = language ?? "";
    _policyBloc.add(PolicyData(base: "privacy-policy",language:_language, token: _token, ));
  }
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        padding:  EdgeInsets.symmetric(horizontal: kIsWeb ? 14 :16.w,vertical: kIsWeb ? 14 :16.h),
                ...
                child: Html(
                  ...
                  style: {
                    "body": Style(
                      ...
                      lineHeight: LineHeight(kIsWeb ? 1.4 :1.5.h),
