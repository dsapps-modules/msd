  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(width:kIsWeb ? 1 : 1.w, color: Theme.of(context).dividerColor),
      ),
      child: Stack(
        children: [
          GoogleMap(
                  ...
                  child: GooglePlaceAutoCompleteTextField(
                      ...
                      inputDecoration: InputDecoration(
                        ...
                        contentPadding: EdgeInsets.symmetric(
                            horizontal: kIsWeb ? 10 :10.w, vertical: kIsWeb ? 2 :2.h),
                      ),
                      debounceTime: 800,
                      countries: const ["bd"],
            ...
            child: Material(
              ...
              child: GooglePlaceAutoCompleteTextField(
                ...
                inputDecoration: InputDecoration(
                  ...
                  border: InputBorder.none,
                  contentPadding:
                      EdgeInsets.symmetric(horizontal:kIsWeb ?10 : 10.w, vertical: kIsWeb ?2 :2.h),
                ),
                getPlaceDetailWithLatLng: (prediction) async {
                  if (prediction.lat != null && prediction.lng != null) {
