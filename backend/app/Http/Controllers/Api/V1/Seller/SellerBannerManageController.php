...
{
    public function __construct(protected BannerInterface $bannerRepo)
    {
    ...
    public function createBanner(SellerBannerRequest $request): JsonResponse
    {
    ...
    public function updateBanner(SellerBannerRequest $request)
    {
