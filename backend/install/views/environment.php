...
<head>
    ...
    <link href="<?php echo $baseUrl; ?>/install/assets/css/loader.css" rel="stylesheet">
...
<div class="card">
    <h2 class="card-title">Connect Database</h2>
    <form class="form" method="POST">
        <div class="form-row">
            <div class="form-group">
                <label for="app_name">Site Name <span class="required_color">*</span></label>
                <input type="text" id="app_name" name="app_name" placeholder="QuickEcommerce" required>
            </div>
            <div class="form-group">
                <label for="db_host">Database Host <span class="required_color">*</span></label>
        ...
        <div class="form-row">
            <div class="form-group">
                <label for="db_port">Database Port <span class="required_color">*</span></label>
                <input type="text" id="db_port" name="db_port" placeholder="3306" required>
            </div>

            <div class="form-group">
                <label for="db_database">Database Name <span class="required_color">*</span></label>
        ...
        <div class="form-row">
            <div class="form-group">
                <label for="admin_url">Admin Panel Url <span class="required_color">*</span></label>
                <input type="text" id="admin_url" name="admin_url" placeholder="https://admin.yourdomain.com/" required>
            </div>

            <div class="form-group">
                <label for="frontend_url">Frontend Url <span class="required_color">*</span></label>
                <input type="text" id="frontend_url" name="frontend_url" placeholder="https://public.yourdomain.com/" required>
            </div>
        </div>

        <div class="form-row">
            <div class="form-group">
                <label for="db_username">Database Username <span class="required_color">*</span></label>
