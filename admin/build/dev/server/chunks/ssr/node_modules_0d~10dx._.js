...
const createContinuablePromise = (store, promise, getValue)=>{
    const buildingBlocks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jotai$2f$esm$2f$vanilla$2f$internals$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["INTERNAL_getBuildingBlocksRev2"])(store);
    const registerAbortHandler = buildingBlocks[26];
            ...
            if (promiseStatus) {
                try {
                    ...
                    if (isPromiseLike(value2)) {
                        attachPromiseStatus(createContinuablePromise(store, value2, ()=>store.get(atom)));
                    }
                } catch (e) {}
            }
...
//# sourceMappingURL=node_modules_0d~10dx._.js.map