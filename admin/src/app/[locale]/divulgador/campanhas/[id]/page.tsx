...
import { DivulgadorCampaignDetails } from "@/components/blocks/divulgador-section/DivulgadorCampaignDetails";
...
export default function DivulgadorCampaignDetailsPage({ params }: Props) {
  const { id } = params;
  ...
  return <DivulgadorCampaignDetails item={divulgadorCampaign} />;
}
