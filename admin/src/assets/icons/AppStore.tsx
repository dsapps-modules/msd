...
const Appstore: React.FC<Props> = ({ width = 30, height = 30 }) => {
  return (
    <div>
      <svg
        ...
        width={width}
        height={height}
        viewBox="-120.015 -200 1040.13 1200"
      >
        <defs>
          <linearGradient
            id="a"
          ...
          >
            <stop offset="0" stopColor="#0ed4fc" />
