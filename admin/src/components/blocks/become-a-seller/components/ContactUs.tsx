...
const ContactUs = ({ data, ID, contact_section }: any) => {
  ...
  return (
    <div
      ...
      style={
        {
          "--register-image": `url(/images/reg_bg.png)`,
    ...
    >
      ...
      <Card className="bg-white w-[349px] md:w-full lg:w-[470px] rounded-md z-10 p-4">
        <div className="mt-6">
          <div>
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="w-full flex items-center justify-center">
                <Button
                  className="bg-blue-500 mt-2 hover:bg-blue-700 px-10 rounded-full"
                  type="submit"
                  disabled={!rememberMe}
                >
                  {isPending ? (
