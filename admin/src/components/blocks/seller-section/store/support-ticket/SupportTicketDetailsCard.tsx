...
import { useReplyMessageMutation } from "@/modules/seller-section/support-ticket/support-ticket.action";
import {
  SupportTicketFormData2,
  supportTicketSchema2,
} from "@/modules/seller-section/support-ticket/support-ticket.schema";
import { useFileUploadService } from "@/modules/seller-section/support-ticket/support-ticket.service";
...
const SupportTicketDetailsCard = ({ data, ID, refetch }: any) => {
  ...
  const { ticket_details = {} } = data.length > 0 ? data[0] : {};
...
const handleFileChange = (event: React.ChangeEvent<HTMLInputElement>) => {
  ...
  const SubmitButton = ({ AddLabel, isLoading }: SubmitButtonProps) => {
    return (
      <Button
        type="submit"
        disabled={isLoading || (!checkedValue.message && !selectedFile)}
                ...
                <div className="flex items-center gap-2">
                  <div className="relative w-[40px] h-[40px] ">
                    <Image
                      ...
                      alt="Admin"
                      layout="fill"
                      className="w-full h-full rounded-full shadow-custom"
                    />
                            ...
                            {message?.role === "system_level" && (
                              <>
                                ...
                                <div>
                                  ...
                                  <p className="text-xs flex items-center justify-end gap-1 text-gray-500 dark:text-white">
                                    {message?.timestamp}
                                  </p>
                                </div>
                              </>
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className=" mt-4">
                  ...
                  <div className="flex items-center gap-4">
                    <span
                      className="cursor-pointer flex items-center gap-2 bg-gray-400 rounded-lg text-white p-2 hover:bg-gray-500"
                      onClick={() =>
                ...
                <div className="p-2">
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-4 ">
                      ...
                      <div className="col-span-3 text-gray-500 dark:text-white text-sm font-medium ">
