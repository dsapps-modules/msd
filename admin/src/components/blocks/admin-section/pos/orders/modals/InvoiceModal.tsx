  ...
  return (
    ...
    >
      {isPending ? (
        ...
        <div ref={invoiceRef} className="p-0 md:p-4">
          <div className="text-black dark:text-white text-base font-semibold flex flex-col md:flex-row items-start md:items-center justify-between gap-2">
            <div className="text-sm md:text-base flex items-start md:items-center">
          ...
          <div className="relative my-12">
            ...
            <>
              <div className="w-full mt-12">
                <div className="grid grid-cols-5 border-t bg-blue-500 text-white text-xs md:text-base font-semibold md:font-bold rounded">
                ...
                <div className="border-b border-gray-300 max-h-[200px] overflow-y-auto custom-scrollbar">
                          ...
                          return (
                            <div key={index}>
                              <div className="grid grid-cols-5 p-2">
                                  ...
                                  <div className="grid grid-cols-2 gap-1">
                                    {Object.entries(variant).map(
                                      ([key, value]) => (
                                        <p
                                          key={key}
                                          className="text-black dark:text-white text-xs md:text-sm font-medium"
                                        >
                                          {key
                                            .replace(/_/g, " ")
                                            .replace(/\b\w/g, (char) =>
                                ...
                                <p className="text-xs md:text-sm font-semibold text-gray-500 dark:text-white text-end">
                                  {price
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 ">
                <div />
                <div className="col-span-2 mx-0 md:mx-6">
