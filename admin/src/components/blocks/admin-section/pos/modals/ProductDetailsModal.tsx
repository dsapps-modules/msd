...
import { useProductDetailsQueryBySKU } from "@/modules/admin-section/pos/Pos.action";
...
export default function ProductDetailsModal({
  ...
  const { productdetails } = useProductDetailsQueryBySKU(slug, locale);
    ...
    <>
      ...
      >
        <motion.div
          ...
          transition={{ duration: 0.6, ease: "easeInOut" }}
          className="custom-scrollbar bg-white dark:bg-[#334155] p-6 rounded-lg shadow-lg w-full max-w-[95%] sm:max-w-[80%] md:max-w-[70%] lg:max-w-[60rem] overflow-y-auto lg:overflow-hidden h-[600px] lg:h-auto min-h-[400px] min-w-[280px] xs:min-w-[350px] md:min-w-[700px] z-90"
