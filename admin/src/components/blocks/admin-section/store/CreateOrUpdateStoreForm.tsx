...
import {
  StoreFormData,
  storeSchema,
} from "@/modules/admin-section/store/store.schema";
...
export default function CreateOrUpdateStoreForm({ data }: any) {
  ...
  useEffect(() => {
    if (editData) {
      ...
      Object?.keys(editData?.translations).forEach((language) => {
        ...
        setValue(
          `meta_title_${language}` as keyof StoreFormData,
      ...
      if (editData?.logo) {
        setLastSelectedLogo({
          ...
          img_url: editData?.logo ? editData?.logo_url : "/images/no-image.png",
          name: "logo",
        });
      }
  ...
  const handleStoreSubmit = async () => {
    ...
    if (Object.keys(watchedValues).length === 0) {
      return toast.error("Please Select Store name ");
    }
    if (values.store_seller_id === "") {
      return toast.error("Please Select Seller ");
    }
    if (values.name_df === "") {
      return toast.error("Please Select Store name ");
    }
  ...
  const { mutate: StoreAdd, isPending } = useAdminStoreMutation();
  ...
  return (
    <div>
      <form onSubmit={handleSubmit(onSubmit)}>
        <>
          <div className="grid grid-cols-1 xl:grid-cols-3  gap-4 mt-4">
                            ...
                            <div className="space-y-4">
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                  ...
                                  <Controller
                                    ...
                                    defaultValue={String(data?.seller_id) || ""}
                                    render={({ field }) => (
                                      <AppSelect
                                        value={field.value || ""}
                                        onSelect={(value) => {
                              ...
                              <div>
                                ...
                                <Input
                                  ...
                                  onChange={(e) => {
                                    ...
                                    if (lang.id === "df") {
                                      // Only update slug for default language
                                      setValue(
                              ...
                              <div>
                                ...
                                <Input
                                  ...
                                  className="app-input"
                                  placeholder={t(
                                    "place_holder.enter_vat_tax_number"
                                  )}
                                />
                              </div>
                              <div className=" grid grid-cols-1 md:grid-cols-2 gap-4">
                                  ...
                                  <Input
                                    ...
                                    defaultValue={
                                      editData?.opening_time
                                        ? formatTime(editData?.opening_time)
                                        : ""
                                    }
                                  ...
                                  <Input
                                    ...
                                    defaultValue={
                                      editData?.closing_time
                                        ? formatTime(editData?.closing_time)
                                        : ""
                                    }
            ...
            <div className="col-span-1 space-y-4 w-full">
              <Card>
                <CardContent className="p-2 md:p-6">
                  <p className="text md:text-2xl font-medium mb-4">
                    {t("label.image")}
                  </p>
        ...
        <Card className="mt-4 sticky bottom-0 w-full p-4 flex items-center">
          <Button
