...
export default function FornecedorSignInForm() {
  ...
  const highlights = useMemo(
    () => [
      "Gestão de produtos e estoque em um só lugar",
      "Controle operacional com acesso por papel",
      "Interface padronizada com o sistema",
    ],
    []
  );
        ...
        >
          <div className="max-w-2xl">
            ...
            <h1 className="mt-6 text-4xl font-semibold leading-tight lg:text-6xl">
              Acesse produtos, estoque e vendas em um só lugar.
            </h1>
            <p className="mt-5 max-w-xl text-base leading-7 text-white/72 lg:text-lg">
              O acesso é separado por papel. O admin vê a visão completa e o
              colaborador fica na operação, sem expor informações indevidas.
            </p>
        ...
        <Card className="self-center rounded-[2rem] border border-white/70 bg-white/90 shadow-[0_20px_60px_rgba(15,23,42,0.12)] backdrop-blur-xl">
          <CardHeader className="px-8 pb-0 pt-8">
            ...
            <p className="mt-2 text-sm text-slate-500">
              Acesse sua área para gerenciar produtos, estoque e vendas
            </p>
          </CardHeader>
          <CardContent className="space-y-5 px-8 py-8">
            <form
              className="space-y-4"
              method="post"
              action={`/${locale}/api/fornecedor/login`}
              noValidate
            >
            ...
            <div className="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-4 text-sm text-slate-600">
              ...
              <p className="mt-2">Admin: admin.fornecedor@teste.com / password</p>
              <p>Colaborador: colaborador.fornecedor@teste.com / password</p>
            </div>
          </CardContent>
        </Card>
      </div>
