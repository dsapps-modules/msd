...
import AuthorTable from "@/components/blocks/seller-section/store/products/author/AuthorTable";
...
const Author = () => {
  ...
  return (
    <>
      ...
      <Card>
        <CardContent className="flex flex-col md:flex-row gap-4  justify-between p-2 md:p-4">
          ...
          <div className="flex flex-col md:flex-row gap-2 items-start md:items-center w-full md:w-auto">
            ...
            <Link href={SellerRoutes.addAuthor}>
              <Button
                variant="outline"
      ...
      <AuthorTable searchValue={searchValue} options={options} />
    </>
  );
};
