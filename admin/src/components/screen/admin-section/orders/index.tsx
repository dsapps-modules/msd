...
import OrdersTable from "@/components/blocks/admin-section/orders/OrdersTable";
            ...
            <div className="flex flex-col md:flex-row items-center justify-end gap-2 w-full">
              <div className="relative flex items-center w-full justify-end">
                ...
                <Input
                  type="text"
                  placeholder={t(
                    "place_holder.search_by_order_id_or_invoice_no"
                  )}
                  value={searchQuery}
                  onKeyDown={handleKeyDown}
                  onChange={handleSearchInputChange}
                  className="mx-0 lg:mx-2 px-8 app-input"
                />
                <Button
                  variant="outline"
